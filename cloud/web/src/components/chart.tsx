...
function ChartContainer({
	...
	// Determine if we have fixed dimensions (not percentages)
	...
	return (
		<ChartContext.Provider value={{ config }}>
			...
			>
				...
				{hasFixedDimensions ? (
					// Direct rendering with fixed dimensions (no ResponsiveContainer)
					React.cloneElement(
					...
					// Use ResponsiveContainer for flexible dimensions
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	// Create CSS rules safely as React elements
	const styleRules = Object.entries(THEMES).map(([theme, prefix]) => {
	...
	return (
		<style>
			{styleRules.map(({ selector, cssVars }) => (
